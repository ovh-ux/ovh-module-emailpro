  ...
  function (
    ...
    function resetCache(key) {
      if (key !== undefined) {
        ...
        for (const request in requests) { // eslint-disable-line
          if (requests.hasOwnProperty(request)) { // eslint-disable-line
    ...
    this.getAccounts = function (pageSize, offset, search, configurableOnly, type, timeout) {
      return this.getSelected()
        .then(exchange => that.getAccountsForEmailPro(
          exchange,
          that.accountsCache,
          pageSize,
          offset,
     ...
     */
    this.getAccountsForEmailPro = function (exchange, cache, pageSizeParam, offsetParam, // eslint-disable-line
     ...
     */
    this.getAccountsAndContacts = function (serviceName, pageSizeParam, offsetParam,
     ...
     */
    this.getAccountDelegationRight = function (serviceName, account, pageSizeParam,
     ...
     */
    this.getMailingListDelegationRights = function (serviceName, mailinglist,
     ...
     */
    this.getAccountsByGroup = function (serviceName, groupName, pageSizeParam,
      offsetParam, searchParam) {
      const pageSize = pageSizeParam !== undefined ? pageSizeParam : 10;
      const offset = offsetParam || 0;
      const search = searchParam || undefined;
     ...
     */
    this.getManagersByGroup = function (serviceName, groupName, pageSizeParam,
      offsetParam, searchParam) {
      const pageSize = pageSizeParam !== undefined ? pageSizeParam : 10;
      const offset = offsetParam || 0;
      const search = searchParam || undefined;
     ...
     * Get managers by group
     */
    this.getMembersByGroup = function (serviceName, groupName, pageSizeParam,
      offsetParam, searchParam) {
      const pageSize = pageSizeParam !== undefined ? pageSizeParam : 10;
      const offset = offsetParam || 0;
      const search = searchParam || undefined;
