angular.module("Module.emailpro.controllers")
    .controller("EmailProUpdateDomainCtrl", ($scope, $stateParams, EmailPro, $rootScope, EmailProDomains, Validator) => {
        ...
        var trimMxRelay = function (mxRelay) {
     ...
     */
        ...
        $scope.isValidMxRelay = function () {
            var mxRelayBuffer = $scope.selectedDomain.mxRelay;
            if (mxRelayBuffer && $scope.selectedDomain.mxRelay[$scope.selectedDomain.mxRelay.length - 1] === ".") {
                mxRelayBuffer = $scope.selectedDomain.mxRelay.substring(0, $scope.selectedDomain.mxRelay.length - 1);
            }
        ...
        $scope.submit = function () {
            ...
            EmailProDomains.updateDomain($stateParams.organization, $stateParams.productId, $scope.selectedDomain)
                .then(() => {
