    ...
    .controller("EmailProAddExternalContactCtrl", class EmailProAddExternalContactCtrl {
        ...
        retrievingAlreadyTakenEmails () {
            ...
            return this.EmailProExternalContacts
                .retrievingContacts(this.$stateParams.organization, this.$stateParams.productId)
                .then((data) => {
        ...
        submitting () {
            ...
            return this.EmailProExternalContacts
                .addingContact(this.$stateParams.organization, this.$stateParams.productId, this.model)
                .then(() => {
        ...
        getEmailErrorMessage () {
            ...
            if (this.isCurrentEmailAlreadyTaken() || (this.externalContactAddForm.emailAddress.$dirty && this.externalContactAddForm.emailAddress.$error.email)) {
