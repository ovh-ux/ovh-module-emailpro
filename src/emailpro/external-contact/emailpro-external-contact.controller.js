angular
  ...
  .controller('EmailProAddExternalContactCtrl', ($scope, $stateParams, $translate, EmailPro, EmailProExternalContacts) => {
    $scope.model = {
      newAccount: {
        hiddenFromGAL: false,
      },
...
angular
  .module('emailproControllers')
  .controller('EmailProExternalContactsModifyCtrl', ($scope, $stateParams, $translate, EmailPro, EmailProExternalContacts) => {
    $scope.model = {
...
angular
  .module('emailproControllers')
  .controller('EmailProExternalContactsDeleteCtrl', ($scope, $stateParams, $translate, EmailPro, EmailProExternalContacts) => {
    $scope.model = {
