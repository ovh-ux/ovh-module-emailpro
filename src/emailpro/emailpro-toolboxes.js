angular.module("Module.emailpro.controllers")
    .controller("EmailProToolboxAccountsCtrl",
                ["$scope",
                    ...
                    function ($scope) {
                        ...
                        $scope.exportAsPst = function (account) {
                            if (account.state === "OK") {
                                $scope.setAction("emailpro/account/export-as-pst/emailpro-account-export-as-pst", angular.copy(account));
                            }
                        };
...
angular.module("Module.emailpro.controllers")
    .controller("EmailProToolboxGroupsCtrl",
                ["$scope",
...
angular.module("Module.emailpro.controllers")
    .controller("EmailProToolboxResourcesCtrl",
                ["$scope", "EmailPro",
...
angular.module("Module.emailpro.controllers")
    .controller("EmailProToolboxDisclaimerCtrl",
                ["$scope",
