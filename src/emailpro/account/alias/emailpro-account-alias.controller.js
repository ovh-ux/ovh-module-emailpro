...
angular
  ...
  .controller('EmailProTabAliasCtrl', ($scope, $stateParams, $translate, EmailPro) => {
...
angular
  .module('emailProControllers')
  .controller('EmailProAddAccountAliasCtrl', ($scope, $stateParams, $translate, EmailPro) => {
...
angular
  .module('emailProControllers')
  .controller('EmailProRemoveAliasCtrl', ($scope, $stateParams, $translate, EmailPro) => {
...
angular
  .module('emailProControllers')
  .controller('EmailProTabGroupAliasCtrl', ($scope, $stateParams, $translate, EmailPro) => {
    $scope.aliasMaxLimit = EmailPro.aliasMaxLimit;
...
angular
  .module('emailProControllers')
  .controller('EmailProAddGroupAliasCtrl', ($scope, $stateParams, $translate, EmailPro) => {
...
angular
  .module('emailProControllers')
  .controller('EmailProRemoveGroupAliasCtrl', ($scope, $stateParams, $translate, EmailPro) => {
