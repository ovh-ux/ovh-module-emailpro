angular
  ...
  .controller('EmailProAccountDelegationCtrl', ($scope, $stateParams, EmailPro, $timeout, $translate) => {
    const init = function () {
...
angular
  .module('emailProControllers')
  .controller('EmailProMailingListDelegationCtrl', ($scope, $stateParams, EmailPro, $timeout, $translate) => {
    const init = function () {
